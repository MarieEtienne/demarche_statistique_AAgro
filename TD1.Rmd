...
## R base
penguins.dta <- read.table('https://agrocampusds.github.io/demarche_statistique/penguins.csv', sep = ';', header = TRUE)
```
...
```{r read_tidy, eval = TRUE, echo = TRUE}
library(tidyverse)
## Lecture tidy
